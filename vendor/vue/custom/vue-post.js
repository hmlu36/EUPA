    ...
    methods: {
        popMessage(mold) {
            ...
            let $element =
                ...
                '             <div class="col-lg-4 col-sm-6 mb-3 justify-content-center">                                                           ' +
                '                 <img src="{path}" class="col-6">                                                                                  ' +
                ...
                '         <div class="row">                                                                                                         ' +
                '             <div class="col-lg-4 col-sm-6 mb-3 justify-content-center text-center">                                                           ' +
                '                 <img src="{recipePath}" class="col-8">                                                                            ' +
                '                 <p ><strong>{recipeTitle}</strong></p>                                                                             ' +
                '             </div>                                                                                                                ' +
                '             <div class="col-6">                                                                                                   ' +
